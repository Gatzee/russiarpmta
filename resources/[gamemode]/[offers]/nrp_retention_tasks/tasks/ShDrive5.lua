...
TASKS_CONFIG[ id ] = {
    ...
    desc = "Проедь 5 километров",

    required_distance = 5000,
        ...
        ping_drive = function( )
            ...
            if self.last_position then
                ...
                if added_distance >= 50 then
                    triggerServerEvent( "onDrive5AddMeters", resourceRoot, added_distance )
...
addEvent( "onDrive5AddMeters", true )
addEventHandler( "onDrive5AddMeters", root, GetSelf( ).fns.ping_drive_rcv )