...
function ShowRewardUI( state )
    if state then
        ...
        UI_elements.lbl_hint
            = ibCreateLabel( 0, 0, 0, 0, "Количество отыгранных часов на сервере: 10", UI_elements.reward_bg, 0xaaFFFFFF, 1, 1, "center" )
...
function Show6SRewardUI_handler( )
    ShowRewardUI( true )
end
addEvent( "Show6SRewardUI", true )
addEventHandler( "Show6SRewardUI", root, Show6SRewardUI_handler )