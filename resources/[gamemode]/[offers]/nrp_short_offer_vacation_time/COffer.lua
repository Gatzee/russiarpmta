...
addEvent( "onPlayerShortOfferVacationTime", true )
addEventHandler( "onPlayerShortOfferVacationTime", localPlayer, function ( )
    destroyWindow( )
    showCursor( true )
    ...
    :ibOnClick( function( key, state )
        ...
        confirmation = ibConfirm( {
            ...
            fn = function( self )
                self:destroy( )
                triggerServerEvent( "onPlayerWantBuyOfferVacationTime", resourceRoot )
