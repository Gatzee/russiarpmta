...
addEvent( "onPlayerShortOfferSick", true )
addEventHandler( "onPlayerShortOfferSick", localPlayer, function ( )
    destroyWindow( )
    showCursor( true )
    ...
    :ibOnClick( function( key, state )
        ...
        confirmation = ibConfirm( {
            ...
            fn = function( self )
                self:destroy( )
                triggerServerEvent( "onPlayerWantBuyOfferSick", resourceRoot )
