...
addEvent( "onPlayerShortOffer5LVL", true )
addEventHandler( "onPlayerShortOffer5LVL", localPlayer, function ( )
    destroyWindow( )
    showCursor( true )
    ...
    :ibOnClick( function( key, state )
        ...
        confirmation = ibConfirm( {
            ...
            fn = function( self )
                self:destroy( )
                triggerServerEvent( "onPlayerWantBuyOffer5LVL", resourceRoot )
