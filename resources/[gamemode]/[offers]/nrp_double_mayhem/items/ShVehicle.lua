...
REGISTERED_ITEMS.vehicle = {
	rewardPlayer_func = function( player, params )
		...
		exports.nrp_vehicle:AddVehicle( pRow, true, "OnDoubleMayhemGiftVehicleAdded", { color = pRow.color, player = player, cost = VEHICLE_CONFIG[ params.model ].variants[ params.variant or 1 ].cost, temp_days = params.temp_days, temp_timeout = pRow.temp_timeout } )
	end;
...
function OnDoubleMayhemGiftVehicleAdded_handler( vehicle, data )
...
addEvent( "OnDoubleMayhemGiftVehicleAdded", true )
addEventHandler( "OnDoubleMayhemGiftVehicleAdded", resourceRoot, OnDoubleMayhemGiftVehicleAdded_handler )