...
addEvent( "onPlayerShortOfferClan", true )
addEventHandler( "onPlayerShortOfferClan", localPlayer, function ( )
    destroyWindow( )
    showCursor( true )
    ...
    :ibOnClick( function( key, state )
        ...
        confirmation = ibConfirm( {
            ...
            fn = function( self )
                self:destroy( )
                triggerServerEvent( "onPlayerWantBuyOfferClan", resourceRoot )
