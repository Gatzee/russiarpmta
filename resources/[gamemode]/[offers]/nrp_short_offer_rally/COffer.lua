...
function showWindow( )
    ...
    :ibOnClick( function( key, state )
        ...
        confirmation = ibConfirm( {
            ...
            fn = function( self )
                self:destroy( )
                triggerServerEvent( "onPlayerWantBuyOfferRally", resourceRoot )
...
addEvent( "onPlayerShortOfferRally", true )
addEventHandler( "onPlayerShortOfferRally", localPlayer, function ( )
    showWindow( )
end )