MAY = {
    create = function( self, offer )
        ...
        for i, v in pairs( label_elements ) do
            UI_elements[ "tick_num_" .. i ] = ibCreateLabel( v[ 1 ] - 15, v[ 2 ] + 12, 0, 0, "0", UI_elements.bg ):ibBatchData( { font = time_font, align_x = "center", align_y = "center" } )
        end
        ...
        for i, v in pairs( buttons ) do
            UI_elements[ 'pack_btn_' .. i ] = ibCreateButton(	v[ 1 ] + 13, v[ 2 ], bsx, bsy, UI_elements.bg,
