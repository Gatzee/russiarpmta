STVALENTINE = {
    create = function( self, offer )
        ...
        for i, v in pairs( label_elements ) do
            UI_elements[ "tick_num_" .. i ] = ibCreateLabel( v[ 1 ] + 10, v[ 2 ] + 12, 0, 0, "0", UI_elements.bg ):ibBatchData( { font = time_font, align_x = "center", align_y = "center" } )
        end
        ...
        UI_elements.timer_timer = Timer( UpdateTimer, 1000, 0 )
