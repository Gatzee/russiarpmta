...
APPLICATIONS.new_year = {
    id = "new_year",
    icon = "img/apps/new_year.png",
    name = "Горячий Новый год",
    elements = { },
	create = function( self, parent, conf )
		...
		self.elements.header = ibCreateImage( 0, 0, 0, 0, "img/elements/events/header/new_year.png", parent ):ibSetRealSize( )
	...
	create_list = function( self )
		...
		local events = exports.nrp_events:GetEventListByGroup( "new_year" )
...
function onEventsUpdatePhoneListCallback_handler( )
	if not NEWYEARAPP then return end
	
	NEWYEARAPP:create_list( )
end
