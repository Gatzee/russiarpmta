...
APPLICATIONS.halloween = {
    id = "halloween",
    icon = "img/apps/halloween.png",
    name = "Хэллоуин",
    elements = { },
	create = function( self, parent, conf )
		...
		self.elements.header = ibCreateImage( 0, 0, 0, 0, "img/elements/events/header/halloween.png", parent ):ibSetRealSize( )
	...
	create_list = function( self )
		...
		local events = exports.nrp_events:GetEventListByGroup( "halloween" )
...
function onEventsUpdatePhoneListCallback_handler( )
	if not HALLOWEENAPP then return end
	
	HALLOWEENAPP:create_list( )
end
