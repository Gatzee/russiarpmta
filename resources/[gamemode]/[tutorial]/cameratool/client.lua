...
outputChatBox("Fast help: Press f9 and click on cameratool for some help!", 255,0,0)
outputChatBox("Fast help: press f2 to open/close the menu!", 255,0,0)
