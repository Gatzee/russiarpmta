...
function ShowJobUI( state )
    if state then
        ...
        UI_elements.bg = ibCreateImage( 0, 0, 800, 580, ":nrp_job_controller/img/park_employee/bg_main.png", UI_elements.black_bg ):center()
        ...
        UI_elements.btn_shift = ibCreateButton( 587, 131, 192, 58, UI_elements.bg, ":nrp_job_controller/img/btn_start_shift.png", ":nrp_job_controller/img/btn_start_shift_h.png", ":nrp_job_controller/img/btn_start_shift_h.png", 0xFFFFFFFF, 0xFFFFFFFF, 0xFF808080 )
            :ibOnClick( function( button, state )
                ...
                triggerServerEvent( "oleg_parkemployee_step_5", localPlayer )
            end )  
        ...
        -- Daily tasks
        local px = 141
        local tasks = { "Начни смену", "Подстриги один участок", "Заверши смену" }
