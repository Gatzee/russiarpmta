...
function RenderDeathText( )
    local text = DEATH_COUNTER > 0 and "Возрождение доступно через: " .. DEATH_COUNTER .. " сек." or  "Нажми ПРОБЕЛ для возрождения"
...
function RequestRespawn()
    ...
    triggerServerEvent( "CEV:OnPlayerRequestRespawn", resourceRoot )
end
