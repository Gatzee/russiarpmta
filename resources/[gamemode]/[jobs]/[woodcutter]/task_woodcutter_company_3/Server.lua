...
function onWoodcutterFinishedProcessWood_handler( player )
	local rewards = {}
...
addEvent( "onWoodcutterFinishedProcessWood" )
addEventHandler( "onWoodcutterFinishedProcessWood", root, onWoodcutterFinishedProcessWood_handler )
