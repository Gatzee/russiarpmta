...
function onWoodcutterFinishedCutting_handler( player )
	local rewards = {}
...
addEvent( "onWoodcutterFinishedCutting" )
addEventHandler( "onWoodcutterFinishedCutting", root, onWoodcutterFinishedCutting_handler )