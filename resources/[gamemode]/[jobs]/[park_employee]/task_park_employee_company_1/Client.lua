...
AREAS = 
{
	...
	{ start = Vector3( 1889.1287, 1038.6082, 16.4156 ), center = Vector3( 1882.1071, 1052.7757, 16.4197 ), area_size = 22 },
	{ start = Vector3( 1963.9298, 1156.2636, 16.4156 ), center = Vector3( 1958.1856, 1143.7795, 16.393 ), area_size = 20 },
	{ start = Vector3( 2182.0771, 1121.5578, 16.4156 ), center = Vector3( 2195.6188, 1113.1292, 16.4755 ), area_size = 20 },
}
...
addEvent("onParkEmployeeCompany_1_EndShiftRequestReset", true)
addEventHandler( "onParkEmployeeCompany_1_EndShiftRequestReset", root, resetParkEmployeeSetting )
