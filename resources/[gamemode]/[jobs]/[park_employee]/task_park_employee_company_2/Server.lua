...
function onParkEmployeeFinishedWatering_handler( player )
	local rewards = {}
...
addEvent( "onParkEmployeeFinishedWatering" )
addEventHandler( "onParkEmployeeFinishedWatering", root, onParkEmployeeFinishedWatering_handler )