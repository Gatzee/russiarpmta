...
function onParkEmployeeFinishedRepair_handler( player )
	local rewards = {}
...
addEvent( "onParkEmployeeFinishedRepair" )
addEventHandler( "onParkEmployeeFinishedRepair", root, onParkEmployeeFinishedRepair_handler )