...
function onFarmerDeliveryPass_handler( player )
...
addEvent( "onFarmerDeliveryPass" )
addEventHandler( "onFarmerDeliveryPass", resourceRoot, onFarmerDeliveryPass_handler )