...
function ShowUI_Market( state, market_id )
	if state then
		...
		ui.title = ibCreateLabel( 80, 200, 0, 0, "ВЕРФЬ", ui.main, 0xFFFFFFFF, 1, 1, "left", "center" ):ibData("font", ibFonts.bold_38)
		...
		ibCreateLabel( 80, scy/2-30, 0, 0, "Мощность:", ui.main, 0x70FFFFFF, 1, 1, "left", "center" ):ibData("font", ibFonts.regular_16)
		...
		ui.power = ibCreateLabel( 235, scy/2-30, 0, 0, "122 л.с.", ui.main, 0xFFFFFFFF, 1, 1, "left", "center" ):ibData("font", ibFonts.bold_16)
		ui.max_speed = ibCreateLabel( 235, scy/2, 0, 0, "500 узлов", ui.main, 0xFFFFFFFF, 1, 1, "left", "center" ):ibData("font", ibFonts.bold_16)
			...
			ui.confirm = ibConfirm(
			    {
			        ...
			        fn = function( self )
						triggerServerEvent("OnPlayerTryBuySpecialBoatVehicle", resourceRoot, { model = pConfig.model_id, variant = 1, color = pAvailableColors[pData.iSelectedColor] } )
			            self:destroy()
					end,
					escape_close = true,
			    }
...
addEvent("ShowUI_SpecialBoatMarket", true)
addEventHandler("ShowUI_SpecialBoatMarket", resourceRoot, ShowUI_Market)
...
function UpdateModel( iAssortmentID )
	...
	ui.power:ibData("text", pVariant.power.." л.с.")
	ui.max_speed:ibData("text", pVariant.max_speed.." узлов")
