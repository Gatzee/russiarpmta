...
CONST_START_POINT = {
	...
	{
		Vector3( -247.4417, 2115.3039 + 860, 21.4061 );
		Vector3( 0, 0, 119 );
	};
}
...
CONST_ROUTE_CHECKPOINTS = {
	...
	{
		Vector3( 593.82, 2588.9 + 860, 11.92 ),
		Vector3( 496.69, 2659.45 + 860, 14.29 ),
		Vector3( 429.34, 2692.64 + 860, 16.01 ),
		Vector3( 71.08, 2645.17 + 860, 20.17 ),
		Vector3( 357.38, 2191.87 + 860, 14.42 ),
		Vector3( 28.94, 2560.99 + 860, 20.61 ),
		Vector3( -145.81, 2349.02 + 860, 20.6 ),
		Vector3( -499.72, 1966.54 + 860, 12.54 ),
		Vector3( 1504.64, 2211.66 + 860, 8.53 ),
		Vector3( 1320.74, 2671.15 + 860, 8.97 ),
		Vector3( 924.53, 2738.33 + 860, 6.96 ),
		Vector3( 19.64, 2793.41 + 860, 14.44 ),
		Vector3( -406.05, 2656.98 + 860, 15.37 ),
		Vector3( -444.55, 2575.31 + 860, 16.28 ),
		Vector3( -556.32, 2536.38 + 860, 16.24 ),
		Vector3( -715.84, 2368.7 + 860, 17.87 ),
		Vector3( -680.29, 2287.13 + 860, 18.57 ),
		Vector3( -691.17, 2164.24 + 860, 18.57 ),
		Vector3( -626.92, 2026.29 + 860, 14.64 ),
		Vector3( -596.02, 1851.9 + 860, 7.3 ),
		Vector3( -727.84, 1774.72 + 860, 9.25 ),
		Vector3( -846.27, 1812.78 + 860, 8.88 ),
		Vector3( -814.91, 2065.05 + 860, 11.87 ),
		Vector3( -817.34, 2335.47 + 860, 17.81 ),
		Vector3( -960.24, 2377.89 + 860, 16.96 ),
		Vector3( -583.48, 2466.6 + 860, 15.94 ),
		Vector3( -1125.59, 2740.06 + 860, 14.31 ),
		Vector3( -1458.49, 2406.48 + 860, 9.51 ),
		Vector3( -1066.78, 2198.91 + 860, 11.25 ),
		Vector3( -668.34, 1850.94 + 860, 10.21 ),
		Vector3( -533.34, 2208.66 + 860, 14.62 ),
		Vector3( -343.74, 2724.01 + 860, 13.93 ),
	};
}
