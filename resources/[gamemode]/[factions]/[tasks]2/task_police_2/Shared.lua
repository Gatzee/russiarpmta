ENTERS = {
	{ x = -358.540, y = -1666.366, z = 22.286 },
	{ x = 1945.049, y = -735.493, z = 60.777 },
	{ x = 1228.635, y = 2194.237, z = 9.686 },
}
		...
		[ 1 ] = {
			...
			Setup = {
				client = function( )
					...
					}, "task_police_2_step_1", _, true )
				end,
			},

			event_end_name = "task_police_2_step_1",
		},
		[ 2 ] = {
			...
			Setup = {
				client = function ( )
					...
					CreateQuestPoint( Vector3( position.x, position.y, position.z ), function ( )
						...
						triggerServerEvent( "task_police_2_step_2", localPlayer )
					end, nil, 3.5, 0, 0, localPlayer.vehicle, nil, nil, "cylinder", 0, 100, 230, 50 )
				end,
			},

			event_end_name = "task_police_2_step_2",
		},
		[ 3 ] = {
				...
				client = function ( )
					...
					local function addNextMarker( )
						...
						if detail then
							...
							triggerServerEvent( "task_police_2_step_3", localPlayer )
						end
					end
					addNextMarker( )
				end,
			...
			event_end_name = "task_police_2_step_3",
		},
		[ 4 ] = {
					...
					CEs.mini_game = {
						...
						nextAction = function ( self )
							...
							if self.counter > 3 then
								triggerServerEvent( "task_police_2_step_4", localPlayer )
							else
			...
			event_end_name = "task_police_2_step_4",
		},
		[ 5 ] = {
			...
			Setup = {
				client = function( )
					CreateQuestPoint( ENTERS[ localPlayer:GetFactionDutyCity( ) ], function ( )
						...
						}, "task_police_2_step_5", _, true )
					end, nil, 1.7, 0, 0, function ( ) return not localPlayer.vehicle end )
				end,
			},

			event_end_name = "task_police_2_step_5",
		},
	},

	GiveReward = function ( player )
		triggerEvent( "onServerCompleteShiftPlan", player, player, "complete_quest", "task_police_2", 16 )
	end,
