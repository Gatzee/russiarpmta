...
CONST_PPS_POINTS = {
	[ 1 ] = Vector3( -338.8296, -1671.2895, 20.7561 );
	[ 2 ] = Vector3( 1929.3632, -716.3528, 60.7831 );
	[ 3 ] = Vector3( 1220.387, 2201.056, 8.810 );
}

CONST_PRISON_POINT = {
	[ 1 ] = Vector3( -2495.3583, 1854.9687, 14.0858 );
	[ 2 ] = Vector3( -2395.7385, 1724.07, 14.0858 );
	[ 3 ] = Vector3( -2460.163, 1624.9587, 14.0858 );
}
