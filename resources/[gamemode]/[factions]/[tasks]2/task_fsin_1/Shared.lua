...
CONST_FSIN_CHECKPOINTS = 
{
	...
	Vector3( -2654.6193, 1561.2695, 14.086 );
	Vector3( -2866.5341, 1847.0717, 14.0874 );
	Vector3( -2812.862, 1626.1801, 14.1251 );
	Vector3( -2801.3627, 1924.8312, 14.098 );
	Vector3( -2651.206, 1920.7575, 14.0844 );
	Vector3( -2457.7734, 1621.7331, 14.0858 );
	Vector3( -2493.6213, 1855.2893, 14.0847 );

	--Вышки
	Vector3( -2769.3271, 1542.9038, 20.1873 );
	Vector3( -2928.0307, 1630.4555, 20.1272 );
	Vector3( -2957.1806, 1871.9636, 20.1272 );
	Vector3( -2788.111, 1989.2587, 20.2063 );
	Vector3( -2558.0642, 1959.9262, 20.2063 );
	Vector3( -2373.8542, 1872.2048, 20.2063 );
	Vector3( -2292.5812, 1663.0571, 20.2063 );
	Vector3( -2516.2897, 1550.4956, 20.1901 );
}
