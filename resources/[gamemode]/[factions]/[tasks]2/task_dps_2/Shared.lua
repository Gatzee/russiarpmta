...
CONST_DPS_CHECKPOINTS = {
	{
		Vector3( -1088.970, -1192.622, 23.002 );
		Vector3( -1101.562, -825.781, 22.983 );
		Vector3( 1434.039, -1752.997, 20.712 );
		Vector3( 1279.110, -1171.640, 19.930 );
		Vector3( -2677.233, -822.486, 19.375 );
		Vector3( 271.639, 367.67, 21.148 );
		Vector3( 291.922, -1760.448, 19.75 );
	};
	{
		Vector3( 1545.681, -1733.739, 20.531 );
		Vector3( 1302.398, -1060.729, 20.179 );
		Vector3( 1715.881, -1314.822, 34.882 );
		Vector3( 867.779, 256.702, 21.027 );
	};
	{
		Vector3( { x = -1274.74, y = 2456.91, z = 12.68 } );
		Vector3( { x = -967.37, y = 2305.68, z = 17.22 } );
		Vector3( { x = -745.76, y = 2542.79, z = 18.11 } );
		Vector3( { x = -284.55, y = 2609.38, z = 15.11 } );
		Vector3( { x = -110.7, y = 2799.62, z = 15.32 } );
		Vector3( { x = -551.34, y = 2031.54, z = 15.4 } );
		Vector3( { x = 431.56, y = 1982.14, z = 8.3 } );
		Vector3( { x = 342.68, y = 2359.33, z = 19.63 } );
		Vector3( { x = 1160.64, y = 2628.05, z = 9.8 } );
		Vector3( { x = 1714.43, y = 2616.04, z = 8.35 } );
		Vector3( { x = 1750.61, y = 2398.59, z = 8.07 } );
		Vector3( { x = 1462.59, y = 2161.9, z = 8.65 } );
		Vector3( { x = 1445.25, y = 2616.84, z = 10.14 } );
		Vector3( { x = 1446.54, y = 2425.49, z = 10.24 } );
		Vector3( { x = 1082.61, y = 2150.62, z = 8.5 } );
		Vector3( { x = 1057.94, y = 1731.35, z = 13.2 } );
		Vector3( { x = 814.82, y = 1880.11, z = 8.5 } );
		Vector3( { x = -39.2, y = 1963.54, z = 8.5 } );
		Vector3( { x = -699.99, y = 1697.34, z = 8.5 } );
		Vector3( { x = -1141.72, y = 2014.28, z = 8.49 } );
		Vector3( { x = 2415.32, y = 2635.97, z = 8.08 } );
		Vector3( { x = 2023.82, y = 2641.54, z = 8.07 } );
		Vector3( { x = 2557.61, y = 2436.96, z = 8.08 } );
		Vector3( { x = 1269.8, y = 2309.71, z = 9.69 } );
	};
}
