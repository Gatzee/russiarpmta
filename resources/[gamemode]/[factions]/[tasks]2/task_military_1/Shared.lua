towers_data = {
	{
		point_position = Vector3( -2610.784, -84.489, 26.143 );
		npc_position = Vector3( -2609.847, -64.708,  20.260  );
		npc_rotation = 227;
	};
	{
		point_position = Vector3( -2472.859, -82.068, 26.143 );
		npc_position = Vector3( -2468.324, 793.270, 20.095 );
		npc_rotation = 300;
	};
	{
		point_position = Vector3( -2446.532, 91.191, 26.143 );
		npc_position = Vector3( -2446.386,  106.307, 19.900 );
		npc_rotation = 24;
	};
	{
		point_position = Vector3( -2311.319, 92.459, 26.143 );
		npc_position = Vector3(  -2297.803, 99.233, 20.098 );
		npc_rotation = 117;
	};
	{
		point_position = Vector3( -2310.753, -94.399, 26.14 );
		npc_position = Vector3( -2296.124, -93.921, 20.102 );
		npc_rotation = 158;
	};
	{
		point_position = Vector3( -2311.094, -349.737, 26.143 );
		npc_position = Vector3( -2295.932, -351.105, 20.101 );
		npc_rotation = 232;
	};
	{
		point_position = Vector3( -2611.113, -347.063, 26.143 );
		npc_position = Vector3( -2628.091, -346.09, 20.634 );
		npc_rotation = 265;
	};
}
...
CONST_TELEPORT_BACK_POSITION = Vector3( -2372.944, -113.476, 21 )
...
QUEST_DATA = {
	...
	tasks = {
		...
		[2] = {
			...
			Setup = {
				client = function()
					CreateQuestPoint( Vector3( -2406.948, -252.055, 20.105 ), "PlayerAction_Task_Militaty_1_step_2" )
				end;
			};
		...
		[5] = {
			...
			Setup = {
				client = function()
					...
					CreateQuestPoint( Vector3( -2406.948, -252.055, 20.105 ), "PlayerAction_Task_Militaty_1_step_5" )
				end;
			};
