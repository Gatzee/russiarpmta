DANCES_LIST = 
{
	...
	{ 
		name = "Двойное сальто назад",
		cost = 900000,
		level = 1,
		anim_data = { "PARKOUR", "corkstfolha" },
		is_looped = false,
		rarity = 3,
		icon = 36,
		is_hidden = true,
	...
	{ 
		...
		cost = 290000,
		level = 1,
		anim_data = { "PARKOUR", "one_handstand" },
		is_looped = false,
		rarity = 3,
		icon = 35,
		is_hidden = true,
	...
	{ 
		...
		cost = 750000,
		level = 1,
		anim_data = { "PARKOUR", "backflip_on_place" },
		is_looped = false,
		rarity = 3,
		icon = 36,
		is_hidden = true,
	...
	{ 
		name = "Стойка на руках 2",
		cost = 2700000,
		level = 1,
		anim_data = { "PARKOUR", "hand_accuracy" },
		is_looped = false,
		rarity = 3,
		icon = 34,
		is_hidden = true,
	...
	{ 
		name = "Стойка на руках 3",
		cost = 1650000,
		level = 1,
		anim_data = { "PARKOUR", "start_handstand" },
		is_looped = false,
		rarity = 3,
		icon = 34,
		is_hidden = true,
