...
function onCasinoRusRouletteStart( player, casino_name, unic_game_id, game_id )
    SendElasticGameEvent( player:GetClientID( ), "casino_rusroulette_start", {
...
function onCasinoRusRouletteLeave( player, player_quantity, room_data, player_data, leave_reason )
    local game_duration = getRealTimestamp() - player_data.start_time
    SendElasticGameEvent( player:GetClientID( ), "casino_rusroulette_leave", {
