SLOT_MACHINE_INTERFACE[ CASINO_GAME_SLOT_MACHINE_CHICAGO ] = function( conf )
    ...
    ibCreateImage( -136 * cfX, -25 * cfY, 1374 * cfX, 605 * cfY, "img/games/" .. conf.game_string_id .. "/machine/window_dcore.png", UI_elements.window ):ibData( "priority", 2 )
    ibCreateImage( 70 * cfX, 42 * cfY, 967 * cfX, 480 * cfY, "img/games/" .. conf.game_string_id .. "/machine/gradient.png", UI_elements.window ):ibData( "priority", 1 )
	ibCreateImage( 0, 0, 1020 * cfX, 264 * cfY, "img/games/" .. conf.game_string_id .. "/machine/selector.png", UI_elements.window ):center(0, 17 * cfY):ibData( "priority", 1 )
	...
	UI_elements.btn_maxbet = ibCreateButton( -19, 41 * cfY - 22, 310 * cfX, 60 * cfY, UI_elements.footer, "img/games/" .. conf.game_string_id .. "/buttons/maxbet_i.png", "img/games/" .. conf.game_string_id .. "/buttons/maxbet_h.png", "img/games/" .. conf.game_string_id .. "/buttons/maxbet_p.png" )
	:ibOnClick( function( key, state )
		if key ~= "left" or state ~= "down" then return end
	...
	UI_elements.btn_play = ibCreateButton( 331 * cfX - 11, 36 * cfY - 21, 182 * cfX, 70 * cfY, UI_elements.footer, "img/games/" .. conf.game_string_id .. "/buttons/play_i.png", "img/games/" .. conf.game_string_id .. "/buttons/play_h.png", "img/games/" .. conf.game_string_id .. "/buttons/play_p.png" )
	:ibOnClick( function( key, state )
		if key ~= "left" or state ~= "down" then return end
	...
	UI_elements.btn_autoplay = ibCreateButton( 531 * cfX + 9, 36 * cfY - 21, 182 * cfX, 70 * cfY, UI_elements.footer, "img/games/" .. conf.game_string_id .. "/buttons/autoplay_i.png", "img/games/" .. conf.game_string_id .. "/buttons/autoplay_h.png", "img/games/" .. conf.game_string_id .. "/buttons/autoplay_p.png" )
	:ibOnClick( function( key, state )
		if key ~= "left" or state ~= "down" then return end
	...
	UI_elements.btn_improvebet = ibCreateButton( 737 * cfX + 14, 41 * cfY - 22, 310 * cfX, 60 * cfY, UI_elements.footer, "img/games/" .. conf.game_string_id .. "/buttons/improvebet_i.png", "img/games/" .. conf.game_string_id .. "/buttons/improvebet_h.png", "img/games/" .. conf.game_string_id .. "/buttons/improvebet_p.png" )
	:ibOnClick( function( key, state )
		if key ~= "left" or state ~= "down" then return end
		playSound( "sfx/slot_machine_max_bet.mp3" )
